...
高機能な日本株式市場分析システム。リアルタイムデータ取得、テクニカル分析、ファンダメンタル分析、ポートフォリオ管理を一つのアプリで実現。

## 🌐 Webアプリケーション

**📱 オンライン版**: [https://japanese-stock-data-app.streamlit.app/](https://japanese-stock-data-app.streamlit.app/)

ブラウザから直接アクセスして、プロフェッショナルレベルの株価分析が可能です。インストール不要で、すぐに利用できます。

## ✨ 主要機能

### 📊 ダッシュボード
- **市場概況**: 日経平均、TOPIX、マザーズ、JASDAQのリアルタイム表示
- **ウォッチリスト**: カスタマイズ可能な銘柄監視機能
- **ポートフォリオサマリー**: 総評価額、損益、収益率の一括表示

### 🔍 銘柄検索・分析
- **コード検索**: 銘柄コードによる高速検索
- **テーマ検索**: 高配当、成長株、ディフェンシブ、インバウンドでカテゴリ分類
- **詳細分析**: 4つのタブで包括的な分析を提供

### 📈 テクニカル分析
- **移動平均線**: 5日、25日、75日移動平均
- **ボリンジャーバンド**: 標準偏差ベースのバンド表示  
- **RSI**: 相対力指数による過買い・過売り判定
- **MACD**: 移動平均収束拡散法による売買シグナル
- **ストキャスティクス**: %K、%Dによるモメンタム分析

### 📋 ファンダメンタル分析  
- **財務指標**: PER、PBR、ROE、ROA、EPS
- **企業情報**: 業種、業界、従業員数、時価総額
- **配当情報**: 配当利回り、配当実績
- **マージン分析**: 売上総利益率、営業利益率
...
- **損益計算**: リアルタイム損益表示
- **平均取得価格**: 自動計算機能
- **パフォーマンス追跡**: 総合収益率、リスク分析

### 📰 マーケットニュース
- **ニュース表示**: カテゴリ別ニュース（今後API連携予定）
- **市況情報**: 主要市場の動向
